...
Jobboard éditorial français — compétences d’abord, transparence, simulations métier, viviers, PPQC, **Savoirs**, **Drive**, **Académie salariés**, **Europe**, **Preuve** et **Passport**.
...
| Académie | Formation salariés branchée à la fiche entreprise (parcours, quiz, attestations) |
