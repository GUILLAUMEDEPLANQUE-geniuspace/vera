...
> = {
  maintenance: {
    ...
    benefits: ["Habilitations internes", "Astreinte écrite", "Outillage perso"],
  ...
  aide: {
    ...
    req: ["Permis B ou mobilité interne", "Écriture", "Dos"],
  ...
  nucl: {
    ...
    req: ["Habilitation ou à passer sur place", "Casier vierge", "Astreinte écrite"],
    benefits: ["Habilitation interne", "Cantine", "Astreinte 1/6"],
...
const ROWS: Row[] = [
  ...
  { slug: "belfort-energie", name: "Belfort Énergie", city: "Belfort", industry: "Énergie", tag: "Ferroviaire et énergie.", about: "Atelier Belfort. Habilitations internes.", metier: "nucl", second: "maintenance" },
  ...
  { slug: "garonne-pv", name: "Garonne PV", city: "Toulouse", industry: "Énergie", tag: "Aéro + solaire.", about: "Chantiers 31. B2V interne.", metier: "elec" },
  ...
  { slug: "vienne-soin", name: "Vienne Soin", city: "Limoges", industry: "Santé", tag: "Rural, plafond tenu.", about: "Domicile 87. Mobilité interne.", metier: "aide", pool: "rsa", barriers: ["mobilite", "equipement"], tryBuy: true },
  ...
  { slug: "paris-fractional", name: "Seine Fractional", city: "Paris", industry: "Industrie", tag: "Créneaux IDF.", about: "Seniors 4–12 h, plusieurs entreprises.", metier: "fractional", slots: true, pool: "senior-fractional" },
  ...
  { slug: "strasbourg-fils", name: "Rhin Fils", city: "Strasbourg", industry: "Énergie", tag: "Transfrontalier, allemand de consigne.", about: "Élec tertiaire 67. Habilitation interne.", metier: "elec", second: "fractional", slots: true, pool: "senior-fractional" },
...
function jobOf(house: Row, key: MetierKey, i: number): SeedJob {
  ...
  return {
    ...
    equity: false,
    description: `${m.title} chez ${house.name}, ${house.city}. ${house.about} ${m.blurb} Salaire publié ${m.salary[0]}–${m.salary[1]} €. Épreuve métier dans l’offre, pacte visible. ${house.tryBuy ? "Try & Buy 5 jours payés, freins cochés J1." : house.slots ? "Créneaux weekday : une entreprise par jour." : "Pas un pool jetable."}`,
